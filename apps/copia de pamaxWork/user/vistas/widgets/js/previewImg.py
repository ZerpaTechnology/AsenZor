...
if data["detalle"]==True:
  ...
  pass
print """            document.getElementById('""",data["output"],"""').insertBefore(span, null);        };      })(f);       /* Read in the image file as a data URL.*/      reader.readAsDataURL(f);    }  }   document.getElementById('""",data["input"],"""').addEventListener('change', handleFileSelect, false);""",